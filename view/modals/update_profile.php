            ...
            $payload = '  <form class="d-flex p-3" method="POST">
                            <div class="card-body">
                                <div class="row">
                                  ...
                                  <input type="hidden" name="upd_profile_id" value="'.$user['id'].'">
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label for="example-text-input" class="form-control-label">Nombre</label>
                                      <input class="form-control" type="text" placeholder="Nombres" name="upd_first_names_profile" value="'.$user['first_names'].'">
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label for="example-text-input" class="form-control-label">Apellidos</label>
                                      <input class="form-control" type="text" placeholder="Apellidos" name="upd_last_names_profile" value="'.$user['last_names'].'">
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label for="example-text-input" class="form-control-label">Fecha de nacimiento</label>
                                      <input class="form-control" type="date" placeholder="21/01/2003" name="upd_birthday_profile" value="'.$user['birthday'].'">
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label for="example-text-input" class="form-control-label">Telefono Celular</label>
                                      <input class="form-control" type="text" placeholder="238-000-00-00" name="upd_cellphone_profile" value="'.$user['cellphone'].'">
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label for="example-text-input" class="form-control-label" >Correo</label>
                                      <input class="form-control" type="text" placeholder="nombre@dominio.com" name="upd_email_profile" value="' .$user['email'].'">
                                    </div>
                                  </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      <label for="example-text-input" class="form-control-label">Genero</label>
                                        <select class="form-control form-control-user" name="upd_gener" required>
