...
$admin->RegisterFullCalendar();
// $admin->UpdateCalendar();
// $admin->DeletedCalendar();
...
<body class="g-sidenav-show   bg-gray-100">
    ...
    <main class="main-content position-relative border-radius-lg ">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body border-radius-lg p-3">
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-3">
                                            <div class="numbers">
                                                ...
                                                <span class="text-sm">Cita aprovada</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex mt-4">
                                        ...
                                        <div class="ms-3">
                                            <div class="numbers">
                                                ...
                                                <span class="text-sm">
                                                    La fecha alcanzo su limite de horas o intentas ocupar una fecha ya agendada 
                                                </span>
                                    ...
                                    <div class="d-flex mt-4">
                                        ...
                                        <div class="ms-3">
                                            <div class="numbers">
                                                <h6 class="mb-1 text-dark text-sm">Precaución</h6>
                                                <span class="text-sm">Día(s) inhábil</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-12 col-md-6 mt-4">
                            <div class="card h-100">
                                <div class="card-body d-flex flex-column justify-content-center text-center">
                                    <a data-bs-toggle="modal" data-bs-target="#DateCalendar">
        ...
        <div class="modal fade" id="DateCalendar" tabindex="-1" aria-labelledby="DateCalendarLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="DateCalendarLabel">Agendar Cita</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <form  class="row g-3" method="POST">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="calendar_title" required>
                            </div>
                           
                            <div class="col-md-6">
                                <label for="fecha" class="form-label">Día</label>
                                <input type="date" min="2023-08-1" max="2023-12-31" class="form-control" name="calendar_day" required>
                            </div>
                            <div class="col-md-6">
                                <label for="hora" class="form-label">Hora inicial</label>
                                <input type="time" min="09:00" max="19:00" class="form-control" name="calendar_hour_start" required>
                            </div>
                            <div class="col-md-6">
                                <label for="hora" class="form-label">Hora culminación</label>
                                <input type="time" min="09:00" max="19:00" class="form-control" name="calendar_hour_end" required>
                            </div>
                            <!-- <div class="col-md-8">
                                <label for="hora" class="form-label"></label>
                                <select class="form-control form-control-user" name="calendar_color" required>
                                    <option selected disabled> Selecciona Estatus</option>
                                    <option value="GREEN">Disponible</option>
                                    <option value="ORANGE">Revición</option>
                                    <option value="RED">Ocupado</option>
                                    <option value="BLUE">Horas extras</option>
                                    <option value="BLACK">Dias inabil</option>
                                </select>
                            </div> -->
                            <div class="col-md-12">
                                <label for="inputDescription" class="form-label">Motivo</label>
                                <textarea type="text" class="form-control" name="calendar_description"></textarea>
                            </div>
                            <div class="p-1 d-grid gap-2 d-md-flex justify-content-md-end">
                                <button type="submit" class="btn btn-success float-end">Agendar</button>
                            </div>
                        </form>
                    </div>
                </div>
